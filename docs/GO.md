...
Read `AGENTS.md`, then `docs/organize.md`, then `docs/RUNLOG.md` and the latest entries in its linked current monthly log, then `notes.md`, then `docs/briefs/INDEX.md`.
...
5) Log a concise entry in the current monthly log linked from `docs/RUNLOG.md` (what changed, what worked, what didn’t, next step).
