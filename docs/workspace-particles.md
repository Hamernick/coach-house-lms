...
- Particles is a tab in the existing workspace drawer. The catalog uses small preview tiles, search, and Roadmap / Drive / Images filters.
...
- Connection handles support the future planning-tree integration. This change does not execute AI planning or model requests.
