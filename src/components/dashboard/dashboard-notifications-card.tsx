    ...
    <Card className={cn("border-border/70 bg-card/70", className)}>
      ...
      <CardContent className="space-y-2">
        {visible.length > 0 ? (
          ...
          <div className="rounded-xl border border-dashed border-border/60 bg-background/50 px-3 py-4">
            <p className="text-sm font-medium text-foreground">No updates yet.</p>
            <p className="mt-1 text-xs text-muted-foreground">Feedback, milestones, and announcements will land here.</p>
          </div>
        )}
      </CardContent>
    </Card>
