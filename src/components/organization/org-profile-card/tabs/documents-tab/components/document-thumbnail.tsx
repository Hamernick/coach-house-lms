  ...
  return (
    ...
    >
      {item.coreDriveSource ? (
        <div className="text-muted-foreground flex flex-col items-center gap-2 px-2 text-center text-sm">
          <GoogleDriveMark />
          <span className="line-clamp-2">{item.coreDriveSource.name}</span>
        </div>
      ) : item.contentPreview ? (
        <div
