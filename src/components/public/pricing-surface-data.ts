...
const TIERS: PricingTier[] = [
  {
    ...
    ctaHref: "/home-canvas?section=signup&intent=build&plan=free",
  ...
  },
  {
    ...
    priceNote: "per month",
    ctaLabel: "Get started",
    ctaHref: "/home-canvas?section=signup&intent=build&plan=organization",
    featured: true,
    badge: "Recommended",
  ...
  },
  {
    ...
    priceNote: "per month",
    ctaLabel: "Get started",
    ctaHref: "/home-canvas?section=signup&intent=build&plan=operations_support",
...
export const FEATURE_GROUPS: FeatureGroup[] = [
  {
    ...
    rows: [
      {
        label: "Guided 501(c)(3) formation",
        tier1: "included",
        tier2: "included",
        tier3: "included",
      },
      ...
      {
        label: "Secure & centralized document storage",
        tier1: "included",
        tier2: "included",
        tier3: "included",
      },
  ...
  },
  {
    ...
    rows: [
      {
        label: "1 Admin Seat (founder only)",
        tier1: "included",
        tier2: "not-included",
        tier3: "not-included",
      },
      {
        label: "8 Admin, Staff, and Board Seats",
        tier1: "not-included",
        tier2: "included",
        tier3: "included",
      },
      {
        label: "Discord + WhatsApp community access",
        tier1: "included",
        tier2: "included",
        tier3: "included",
      },
      {
        label: "Weekly members only programming",
        tier1: "not-included",
        tier2: "included",
        tier3: "included",
      },
  ...
  },
  {
    ...
    rows: [
      {
        label: "Accelerator access",
        tier1: "not-included",
        tier2: "included",
        tier3: "included",
      },
      {
        label: "Electives & additional learning",
        tier1: "not-included",
        tier2: "included",
        tier3: "included",
      },
      {
        label: "Fiscal sponsorship opportunities",
        tier1: "not-included",
        tier2: "included",
        tier3: "included",
      },
      {
        label: "Quantitative fundability readiness tracker",
        tier1: "not-included",
        tier2: "included",
        tier3: "included",
      },
      {
        label: "Qualitative through-line analysis",
        tier1: "not-included",
        tier2: "included",
        tier3: "included",
      },
  ...
  },
  {
    ...
    rows: [
      ...
      {
        label: "Expanded delivery and operations support",
        tier1: "not-included",
        tier2: "not-included",
        tier3: "included",
      },
      {
        label: "Discounted coaching",
        tier1: "not-included",
        tier2: "not-included",
        tier3: "included",
      },
