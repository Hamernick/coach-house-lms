...
export function ensureClusterLayers(map: mapboxgl.Map) {
...
export function ensurePointLayers(map: mapboxgl.Map) {
...
export function ensureSelectedLayers(map: mapboxgl.Map) {
...
export function refreshLayerContracts(map: mapboxgl.Map) {
