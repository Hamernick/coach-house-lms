...
## Ownership
- Domain logic: `src/features/email-ops/lib/**`
- Server actions/queries: `src/features/email-ops/server/**`
- UI components: `src/features/email-ops/components/**`
- Hooks/controllers: `src/features/email-ops/hooks/**`
...
- Keep acceptance coverage in `tests/acceptance/email-ops.test.ts`.
