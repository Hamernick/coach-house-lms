      ...
      >
        ...
        <ul className="mt-3 space-y-4">
          {article.whyItMatters.map((item) => (
            <li
              key={item}
              className="grid grid-cols-[1.25rem_1fr] gap-3 text-sm leading-5 sm:text-sm sm:leading-6"
            >
        ...
        <div className="bg-muted/30 mt-5 rounded-xl border px-4 py-4 text-sm leading-5">
          ...
          {article.framework.map((step, index) => (
            ...
            >
              ...
              <div>
                ...
                <p className="mt-3 text-sm leading-5 italic">
                  Prompt: {step.prompt}
                </p>
              </div>
            </li>
