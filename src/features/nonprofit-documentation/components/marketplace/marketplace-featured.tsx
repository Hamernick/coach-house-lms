...
export function MarketplaceFeatured() {
  return (
    <div className="mb-8 grid overflow-hidden rounded-3xl border md:grid-cols-[minmax(0,1fr)_minmax(14rem,0.7fr)]">
      <div className="bg-muted/20 p-6 sm:p-8">
        <p className="text-muted-foreground text-xs font-medium">
          Google Ad Grants
        </p>
        <h2 className="mt-2 max-w-lg text-2xl font-semibold tracking-tight text-balance">
      ...
      <div
        className="relative flex min-h-36 flex-col justify-end overflow-hidden bg-[radial-gradient(ellipse_at_15%_15%,#4754bc,transparent_65%),radial-gradient(ellipse_at_85%_20%,#546380,transparent_70%),linear-gradient(145deg,#472876,#142c63)] p-6 text-white sm:p-8"
      ...
      >
        ...
        <p
          className="mt-1 text-5xl font-medium tracking-tight tabular-nums"
          aria-hidden
        >
          $10,000
          <span className="ml-1 text-lg font-normal tracking-normal">/mo</span>
        </p>
