...
import { ClientStatusBadge } from "@/features/platform-admin-dashboard/upstream/components/clients/ClientStatusBadge"
import { getClientById, getProjectCountForClient, clients, type Client } from "@/features/platform-admin-dashboard/upstream/lib/data/clients"
                        ...
                        <div className="rounded-lg border border-border bg-card/80 overflow-hidden">
                          <div className="divide-y divide-border/80">
                            {relatedProjects.map((p) => (
                              <Link
                                key={p.id}
                                href={platformLabPath(`/projects/${p.id}`)}
