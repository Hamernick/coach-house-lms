...
import type { Project } from "@/features/platform-admin-dashboard/upstream/lib/data/projects"
...
import { PriorityBadge } from "@/features/platform-admin-dashboard/upstream/components/priority-badge"
import { ProjectProgress } from "@/features/platform-admin-dashboard/upstream/components/project-progress"
...
export function ProjectCard({ project, actions, variant = "list" }: ProjectCardProps) {
  ...
  const goToDetails = () => router.push(platformLabPath(`/projects/${project.id}`))
