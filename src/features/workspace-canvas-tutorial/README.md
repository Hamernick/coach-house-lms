# WorkspaceCanvasTutorial Feature

## Ownership
- Domain logic: `src/features/workspace-canvas-tutorial/lib/**`
- Server actions/queries: `src/features/workspace-canvas-tutorial/server/**`
- UI components: `src/features/workspace-canvas-tutorial/components/**`
- Hooks/controllers: `src/features/workspace-canvas-tutorial/hooks/**`
...
- Keep acceptance coverage in `tests/acceptance/workspace-canvas-tutorial.test.ts`.
