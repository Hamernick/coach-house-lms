...
export const env: ServerEnv = assertEnv(serverEnvSchema, {
  ...
  STRIPE_COACHING_DISCOUNTED_PRICE_ID: process.env.STRIPE_COACHING_DISCOUNTED_PRICE_ID,
  STRIPE_TEST_COACHING_FULL_PRICE_ID: process.env.STRIPE_TEST_COACHING_FULL_PRICE_ID,
  ...
  GOOGLE_COACHING_GCP_PROJECT_NUMBER: process.env.GOOGLE_COACHING_GCP_PROJECT_NUMBER,
  ...
  GOOGLE_COACHING_IMPERSONATED_USER: process.env.GOOGLE_COACHING_IMPERSONATED_USER,
  GOOGLE_COACHING_JOEL_IMPERSONATED_USER: process.env.GOOGLE_COACHING_JOEL_IMPERSONATED_USER,
  GOOGLE_COACHING_PAULA_IMPERSONATED_USER: process.env.GOOGLE_COACHING_PAULA_IMPERSONATED_USER,
  GOOGLE_COACHING_JOEL_CALENDAR_ID: process.env.GOOGLE_COACHING_JOEL_CALENDAR_ID,
  GOOGLE_COACHING_PAULA_CALENDAR_ID: process.env.GOOGLE_COACHING_PAULA_CALENDAR_ID,
