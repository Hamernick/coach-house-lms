...
describe("coaching booking feature", () => {
  it("adds coaching as a dashboard route backed by a feature slice", () => {
    ...
    expect(flow).toContain("lets talk business")
    ...
    expect(flow).toContain("min-h-full px-3 py-4 sm:px-4 sm:py-6 lg:px-6")
    expect(flow).toContain("lg:grid-cols-[260px_12.75rem]")
    expect(flow).toContain("lg:justify-start")
    expect(flow).toContain("mx-auto flex w-[316px] max-w-full flex-col gap-7")
    ...
    expect(flow).toContain("w-[316px] max-w-full min-w-0 lg:w-[260px]")
    expect(flow).toContain(
      "w-[316px] max-w-full p-0 [--cell-size:--spacing(10)] lg:w-[260px] lg:[--cell-size:--spacing(8)]",
    )
    expect(flow).not.toContain("w-fit max-w-full p-0 [--cell-size:--spacing(10)]")
    expect(flow).not.toContain("p-0 [--cell-size:calc((100%_-_2.25rem)/7)]")
    expect(flow).toContain("flex w-[316px] max-w-full min-w-0 flex-col gap-4 lg:w-[12.75rem] lg:gap-3")
