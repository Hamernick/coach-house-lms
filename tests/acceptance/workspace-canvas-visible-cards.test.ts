...
describe("workspace canvas visible cards", () => {
  it("keeps secondary surfaces out of the live canvas card set", () => {
    ...
    expect(visibleCardIds).not.toContain("accelerator")
  ...
  it("still respects hidden-card filtering for the remaining live canvas cards", () => {
    ...
    expect(visibleCardIds).not.toContain("fiscal-sponsorship")
